...
# import core modules
from aswl.layers import AttentionConv2D as Conv2D
from aswl.layers import AttentionDense as Dense

def block2(x: tf.Tensor, filters: int, kernel_size: int=3, stride: int=1, conv_shortcut: bool=False, name=None):
    """A residual block.
    Arguments:
        x: input tensor.
...
def stack2(x: tf.Tensor, filters: int, blocks: int, stride1: int=2, name=None) -> tf.Tensor:
